...
#TODO: File requires comments (mcox 10Apr21) 
setup(name='midca',
      version='1.4',
      description='Metacognitive Integrated Dual-Cycle Architecture (MIDCA)',
      author='Michael T. Cox and Collaboration and Cognition Lab',
      ...
      packages=['midca',
                ...
                'midca.domains.chicken',
                'midca.domains.chicken.plan',
                ...
                #TODO do we need to add 'midca.tests',
                'midca.worldsim',
                'midca.examples',

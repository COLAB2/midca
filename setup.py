...
setup(name='midca',
      ...
      packages=['midca',
                ...
                'midca.domains.minecraft',
                'midca.domains.ffdomain',
                'midca.domains.ffdomain.minecraft',
      ...
      package_data={'': ['*.jar', 'midca.modules._plan.jShop'],
                    ...
                    '': ['*.*', 'midca.modules._plan.jShop'],
                    '': ['*.*', 'midca.modules._plan.metricFF'],
                    '': ['*.pddl', 'midca.domains.jshop_domains.blocks_world'],
                    '': ['*.shp', 'midca.domains.ffdomain.minecraft']},
      )

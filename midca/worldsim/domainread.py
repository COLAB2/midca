...
def operator(name, args=[], preconditions=[], results=[]):
    ...
    operators[name] = worldsim.Operator(name, objnames, prepredicates, preobjnames, preobjtypes, prePositive,
                                        postpredicates, postobjnames, postobjtypes, postPositive)
...
def operator_no_side_effect(name, args=[], preconditions=[], results=[]):
    ...
    for condition in results:
        ...
        postobjtypes.append(objtypes)
        postPositive.append(condition.positive)
    return worldsim.Operator(name, objnames, prepredicates, preobjnames, preobjtypes, prePositive, postpredicates,

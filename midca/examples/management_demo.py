...
DOMAIN_FILE = DOMAIN_ROOT + "domain/organization_domain.sim"
STATE_FILE = DOMAIN_ROOT + "states/organization_state.sim"
...
myMidca.append_module("Interpret", guide.ManagementGoalInput())

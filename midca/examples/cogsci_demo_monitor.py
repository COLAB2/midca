...
from midca.domains.blocksworld.plan import methods_arson, operators
...
DOMAIN_FILE = DOMAIN_ROOT + "domains/arsonist_badcondition.sim"
STATE_FILE = DOMAIN_ROOT + "states/defstate_mon.sim"
DISPLAY_FUNC = util.asqiiDisplay
DECLARE_METHODS_FUNC = methods_arson.declare_methods
DECLARE_OPERATORS_FUNC = operators.declare_ops
GOAL_GRAPH_CMP_FUNC = util.preferMaintain
...
myMidca.insert_module('Simulate', simulator.BadWorkingConditionSimulator(), 1)
myMidca.insert_module('Simulate', simulator.FireReset(), 0)
myMidca.insert_module('Interpret', guide.TFStack(), 1)
myMidca.insert_module('Interpret', guide.TFFire(), 2)
myMidca.insert_module('Interpret', guide.ReactiveConstruction(), 3)

...
simple_run: Runs a simple version of MIDCA with only user-defined goal
generation

simple_run_arson: Adds to simple_run TF-Tree goal generation and an
arsonist who sets fires

run_extinguish: adds to simple_run the need to be holding a fire
...
cogsci_demo_ma: connects to Meta-AQUA instead of using simulated goal
generation.

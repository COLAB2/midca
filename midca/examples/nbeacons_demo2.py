...
from midca.domains.grace import nbeacons_util
from midca.domains.grace.plan import methods_nbeacons, operators_nbeacons
...
STATE_FILE = DOMAIN_ROOT + "states/nbeastates.sim" # state file is generated dynamically
...
#myMidca.append_module("Simulate", simulator.GraceDataActionSimulator())
...
myMidca.append_module("Interpret", guide.GraceGoalInput())

...
DOMAIN_ROOT = MIDCA_ROOT + "domains/blocksworld_Updated/"
...
JSHOP_DOMAIN_FILE = DOMAIN_ROOT + "plan/blocksworld.shp"
JSHOP_STATE_FILE = DOMAIN_ROOT + "plan/bw_ran_problems_5.shp"

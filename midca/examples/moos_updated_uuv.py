...
DOMAIN_FILE = DOMAIN_ROOT + "domain/moos_updated.sim"
STATE_FILE = DOMAIN_ROOT + "states/moos_updated_state.sim"
...
JSHOP_DOMAIN_FILE = MIDCA_ROOT + "domains/moos_domain/plan/MoosDomain.shp"
JSHOP_STATE_FILE = MIDCA_ROOT + "domains/moos_domain/plan/MoosProblem.shp"
...
myMidca.append_module("Perceive",perceive.MoosObserverUpdated())
myMidca.append_module("Interpret", guide.MoosGoalInput(deadline=700))
myMidca.append_module("Eval", evaluate.SimpleEval_moos())
myMidca.append_module("Intend", intend.SimpleIntendSelectAll())
myMidca.append_module("Plan", planning.JSHOPPlannerAsync(util.jshop2_state_from_world,
                                                         util.jshop2_tasks_from_goals,
                                                         JSHOP_DOMAIN_FILE,
                                                         JSHOP_STATE_FILE,
                                                         asynch_updated_moos,
                                                         util.monitor

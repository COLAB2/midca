...
def GetmaskForBlue(hsv):
    #lower_blue = np.array([90,120,60], dtype=np.uint8)
...
def GetmaskForRed(hsv):
    lower_red = np.array([0,150,50], dtype=np.uint8)
...
def main():
    ...
    boundaries = {#'blue block':([90,120,60], [120,255,255]),
		  'blue block':([110,50,50], [130,255,255]),
		  #'blue block':([80,50,50], [140,255,255]),
                  #'pink block' : ([165,50,200], [175,255,255]),
                  #'darkgreen block': ([65,255,102], [85,255,102]),
                  #'green block': ([30,150,50], [80,255,255]),
		  'green block': ([50,100,50], [80,255,255]),
		  'red block':([0,150,50], [10,255,255])
                  #'red block':([0,150,50], [10,255,255])
		  #'red block':([0,90,50], [10,255,255])
		  #'atrium_red block':([0, 50, 23], [20, 255, 255])
                  #[30,100,50], [70,255,255]
                  #'darkred block':([0, 255, 87], [10, 255, 87]),s

...
angleRanges = {'right_s0': Range(-2, .5), 'right_s1': Range(-1.35, 0.5), 'right_w0': Range(-2.5, 2.5),
               'right_w1': Range(-1, 1.5), 'right_w2': Range(-2.5, 2.5), 'right_e0': Range(-2.5, 2.5),
               'right_e1': Range(0.3, 2.1), 'left_s0': Range(-2, .5), 'left_s1': Range(-1.35, 0.5),
               'left_w0': Range(-2.5, 2.5), 'left_w1': Range(-1, 1.5), 'left_w2': Range(-2.5, 2.5),
               'left_e0': Range(-2.5, 2.5), 'left_e1': Range(0.3, 2.1)}

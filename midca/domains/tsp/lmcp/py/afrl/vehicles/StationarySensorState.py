...
class StationarySensorState(EntityState.EntityState):

    def __init__(self):
        EntityState.EntityState.__init__(self)
        self.LMCP_TYPE = 6
        self.SERIES_NAME = "VEHICLES"
        self.FULL_LMCP_TYPE_NAME = "afrl.vehicles.StationarySensorState"
    ...
    def toString(self):
        ...
        buf += "From StationarySensorState:\n"
    ...
    def toDict(self):
        ...
        if (not "VEHICLES") or (len("VEHICLES") == 0): # this should never happen
            ...
            d["datatype"] = str("DEBUG_PROBLEM_HERE" + "/StationarySensorState")
            d["datastring"] = str(m)
        else:
            d['datatype'] = str("VEHICLES" + "/StationarySensorState")
            d['datastring'] = str(m)
        return d

...
class TaskAutomationResponse(LMCPObject.LMCPObject):

    def __init__(self):

        self.LMCP_TYPE = 7
        self.SERIES_NAME = "UXTASK"
        self.FULL_LMCP_TYPE_NAME = "uxas.messages.task.TaskAutomationResponse"
    ...
    def toString(self):
        ...
        buf += "From TaskAutomationResponse:\n"
    ...
    def toDict(self):
        ...
        if (not "UXTASK") or (len("UXTASK") == 0): # this should never happen
            ...
            d["datatype"] = str("DEBUG_PROBLEM_HERE" + "/TaskAutomationResponse")
            d["datastring"] = str(m)
        else:
            d['datatype'] = str("UXTASK" + "/TaskAutomationResponse")
            d['datastring'] = str(m)
        return d

...
class TaskProgressRequest(LMCPObject.LMCPObject):
    ...
    def __init__(self):
        ...
        self.FULL_LMCP_TYPE_NAME = "uxas.messages.task.TaskProgressRequest"
    ...
    def toDict(self):
        ...
        if (not "UXTASK") or (len("UXTASK") == 0): # this should never happen
            ...
            d["datatype"] = str("DEBUG_PROBLEM_HERE" + "/TaskProgressRequest")
            d["datastring"] = str(m)
        else:
            d['datatype'] = str("UXTASK" + "/TaskProgressRequest")
            d['datastring'] = str(m)
        return d

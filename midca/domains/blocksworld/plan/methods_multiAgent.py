...
def communicate(state, agent, other_agent, other_agent_goal, predicate, negate):
    if not negate:
        if predicate == "committed":
            return [("inform", agent, other_agent, other_agent_goal, "accepted"), ("commit", agent, other_agent, other_agent_goal, "accepted")]
        elif predicate == "rejected":
            return [("inform", agent, other_agent, other_agent_goal, "denied"), ("reject", agent, other_agent, other_agent_goal, "denied")]
        elif predicate == "requested":
            return [("ask", agent, other_agent, other_agent_goal, "achieve"), ("wait", agent, other_agent, other_agent_goal, "achieve")]
        else:
            return []
    else:
        if predicate == "committed":
            return [("inform", agent, other_agent, other_agent_goal, "achieved"), ("uncommit", agent, other_agent, other_agent_goal, "achieved")]
        return []
...
def declare_methods(longApprehend = True):
    ...
    pyhop.declare_methods('communicated',communicate)

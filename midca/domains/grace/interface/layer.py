...
def generate_tags(N=1000):
    ...
    """
    density_map = np.array([0.1, 0.1, 0.4, 0.3, 0.2, 0.1, 0.1, 0.4, 0.3, 0.2, 0.1,
                            0.1, 0.3, 0.3, 0.1, 0.3, 0.1, 0.1, 0.4, 0.3, 0.2, 0.1,
                            0.2, 0.3, 0.3, 0.2, 0.1, 0.1, 0.1, 0.4, 0.3, 0.2, 0.1,
                            0.3, 0.9, 0.3, 0.2, 0.1, 0.1, 0.1, 0.4, 0.3, 0.2, 0.1,
                            0.2, 0.3, 0.2, 0.1, 0.1, 0.1, 0.1, 0.4, 0.3, 0.2, 0.1,
                            0.2, 0.3, 0.3, 0.2, 0.1, 0.1, 0.1, 0.4, 0.3, 0.2, 0.1,
                            0.3, 0.9, 0.3, 0.2, 0.1, 0.1, 0.1, 0.4, 0.3, 0.2, 0.1,
                            0.2, 0.3, 0.2, 0.1, 0.1, 0.1, 0.1, 0.4, 0.3, 0.2, 0.1])
    """
    density_map=np.array([0.1, 0.1, 0.2, 0.3, 0.2,
                           0.1, 0.2, 0.2, 0.9, 0.2,
                           0.3, 0.4, 0.2, 0.2, 0.1,
                           0.1, 0.9, 0.3, 0.2, 0.1,
                           0.3, 0.2, 0.3, 0.1, 0.1])
...
# lay mines in moos
minelayer.write_to_file(taglist, filename = "/home/sampath/moos-ivp/moos-ivp-midca/missions/multi_agent/tags.txt")

...
for i in range(N):
	delay=17#max(1,30*np.random.rand())
...
density_map = np.array([0.1, 0.1, 0.4, 0.3, 0.2,
						...
						0.3, 0.9, 0.3, 0.2, 0.1,
						0.2, 0.3, 0.2, 0.1, 0.1])
density_map2 = np.array([0.1, 0.1, 0.4, 0.3, 0.2,
						0.1, 0.05, 0.05, 0.05, 0.1,
						0.2, 0.05, 0.9, 0.05, 0.1,
						0.3, 0.05, 0.05, 0.05, 0.1,
						0.2, 0.3, 0.2, 0.1, 0.1])
density_map3 = np.array([0.8, 0.1, 0.4, 0.1, 0.8,
						0.1, 0.06, 0.15, 0.08, 0.1,
						0.2, 0.09, 0.4, 0.05, 0.1,
						0.1, 0.05, 0.05, 0.07, 0.1,
						0.8, 0.1, 0.2, 0.1, 0.8])
grid.setMap(density_map3)#set map with no arguement sets the default map
